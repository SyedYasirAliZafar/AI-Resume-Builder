...
const ProfessionalSummary = ({data, onChange, setResumeData}) => {
  ...
  const generateSummary = async () => {
    try {
      ...
      setResumeData(prev => ({...prev, professional_summary: response.data.enhancedContext}))
    ...
    <div className='space-y-4'>
      <div className='flex items-center justify-between'>
        ...
        <div className='mt-6'>
            ...
            name="" id="" className='w-full p-3 px-4 mt-2 border text-sm border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500 outline-none transition-colors resize-none' placeholder='Write a compelling professional summary that highlights your key strengths and career objective...' rows={7}></textarea>
